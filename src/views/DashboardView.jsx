...
// =============================================================================
// Mostra:
// 1. Header con logo 01Informatica, toggle tema e logout
// 2. Hero card con pulsante "NUOVA ANALISI" (naviga a /insert)
// 3. Classifica live (leaderboard) dei club per punteggio totale
//
// LOGICA CLASSIFICA:
// - Legge tutti i record da 'service_inseriti' con JOIN su 'club'
// - Aggrega i punteggi per nome club (un club può avere più inserimenti)
// - Ordina decrescente per punteggio
//
// COLLEGAMENTI:
// - Usa supabase per leggere da service_inseriti + club
// - Pulsante "NUOVA ANALISI" naviga a /insert (InsertWizardView)
// - Riceve ThemeSwitcher come prop per il toggle tema
// =============================================================================
...
export default function DashboardView({ resolvedTheme, ThemeSwitcher }) {
  ...
  // leaderboard: array ordinato [{nome: "Club X", score: 42.5}, ...]
  const [leaderboard, setLeaderboard] = useState([]);

  // ===========================================================================
  // useEffect: Carica la classifica al mount del componente
  // Query: service_inseriti LEFT JOIN club → aggrega punteggi per club
  // ===========================================================================
  useEffect(() => {
    const fetchLeaderboard = async () => {
      // Join con tabella club per ottenere il nome del club
      ...
      if (data) {
        // Aggregazione: somma tutti i punteggi per ogni club
        ...
        // Conversione in array e ordinamento decrescente
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-12 space-y-10 pb-24 text-brand-dark dark:text-white">
        {/* HERO: titolo + pulsante nuova analisi */}
        <div className="p-10 rounded-[3.5rem] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 relative overflow-hidden shadow-xl group">
          ...
          <div className="relative z-10 text-center sm:text-left">
            ...
            {/* Pulsante che naviga a /insert per iniziare il wizard */}
            <button
        ...
        {/* LEADERBOARD: lista ordinata dei club */}
              ...
              leaderboard.map((item, i) => (
                ...
                >
                  <div className="flex items-center gap-6">
                    {/* Badge posizione: oro per #1, argento per #2, default per gli altri */}
                    <div
