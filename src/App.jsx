  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/nuovo-socio" element={
          user ? <InsertMemberView {...authProps} /> : <Navigate to="/login" replace />
        } />
        <Route path="/nuovo-officer" element={
          user ? <InsertOfficerView {...authProps} /> : <Navigate to="/login" replace />
        } />
